...
class Case(Base):
    ...
    # System Metadata
    status = Column(String, default=FIRStatus.DRAFT, index=True) # Enum stored as string, indexed for filtering
    police_station_id = Column(String, nullable=True, index=True) # Indexed for filtering by station
