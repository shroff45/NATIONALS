...
def run_registry_scrutiny_test():
    try:
...
def main():
    ...
    results = [
        run_health_test(),
        run_registry_scrutiny_test(),
        run_registry_fees_test(),
        run_listing_pending_test(),
        run_listing_optimize_test()
    ]
