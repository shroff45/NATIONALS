...
def main():
    ...
    results = [
        check_health(),
        check_registry_scrutiny(),
        check_registry_fees(),
        check_listing_pending(),
        check_listing_optimize()
    ]
