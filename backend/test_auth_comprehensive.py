...
def record_test_result(name, condition, details=""):
    """Record test result"""
...
def run_tests():
    ...
    try:
        ...
        record_test_result("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        record_test_result("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        record_test_result("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        record_test_result("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        record_test_result("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        record_test_result("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        record_test_result("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            record_test_result("Token verification works", False, str(e))
    else:
        record_test_result("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            record_test_result("Police token verification", False, str(e))
