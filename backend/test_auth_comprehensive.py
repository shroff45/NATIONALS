...
def run_tests():
    ...
    try:
        ...
        check_assertion("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        check_assertion("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        check_assertion("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        check_assertion("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        check_assertion("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        check_assertion("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        check_assertion("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            check_assertion("Token verification works", False, str(e))
    else:
        check_assertion("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            check_assertion("Police token verification", False, str(e))
