...
def run_tests():
    ...
    try:
        ...
        record_result("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        record_result("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        record_result("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        record_result("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        record_result("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        record_result("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        record_result("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            record_result("Token verification works", False, str(e))
    else:
        record_result("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            record_result("Police token verification", False, str(e))
