...
def run_tests():
    ...
    try:
        ...
        check_step("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        check_step("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        check_step("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        check_step("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        check_step("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        check_step("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        check_step("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            check_step("Token verification works", False, str(e))
    else:
        check_step("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            check_step("Police token verification", False, str(e))
