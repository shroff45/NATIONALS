...
def verify_auth_condition(name, condition, details=""):
    """Record test result"""
...
def run_tests():
    ...
    try:
        ...
        verify_auth_condition("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        verify_auth_condition("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        verify_auth_condition("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        verify_auth_condition("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        verify_auth_condition("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        verify_auth_condition("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        verify_auth_condition("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            verify_auth_condition("Token verification works", False, str(e))
    else:
        verify_auth_condition("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            verify_auth_condition("Police token verification", False, str(e))
