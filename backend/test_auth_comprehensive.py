...
def run_tests():
    ...
    try:
        ...
        run_test("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        run_test("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        run_test("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        run_test("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        run_test("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        run_test("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        run_test("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            run_test("Token verification works", False, str(e))
    else:
        run_test("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            run_test("Police token verification", False, str(e))
