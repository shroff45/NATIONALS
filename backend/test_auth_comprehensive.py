...
def run_tests():
    ...
    try:
        ...
        check_condition("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        check_condition("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        check_condition("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        check_condition("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        check_condition("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        check_condition("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        check_condition("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            check_condition("Token verification works", False, str(e))
    else:
        check_condition("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            check_condition("Police token verification", False, str(e))
