...
def verify_verify_test(name, condition, details=""):
    """Record test result"""
...
def run_tests():
    ...
    try:
        ...
        verify_test("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        verify_test("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        verify_test("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        verify_test("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        verify_test("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        verify_test("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        verify_test("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            verify_test("Token verification works", False, str(e))
    else:
        verify_test("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            verify_test("Police token verification", False, str(e))
