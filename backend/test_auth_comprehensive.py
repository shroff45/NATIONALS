...
def verify_auth_comprehensive(name, condition, details=""):
    """Record test result"""
...
def run_tests():
    ...
    try:
        ...
        verify_auth_comprehensive("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        verify_auth_comprehensive("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        verify_auth_comprehensive("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        verify_auth_comprehensive("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        verify_auth_comprehensive("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        verify_auth_comprehensive("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        verify_auth_comprehensive("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            verify_auth_comprehensive("Token verification works", False, str(e))
    else:
        verify_auth_comprehensive("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            verify_auth_comprehensive("Police token verification", False, str(e))
