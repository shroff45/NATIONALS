...
def run_test_item(name, condition, details=""):
    """Record test result"""
...
def run_tests():
    ...
    try:
        ...
        run_test_item("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        run_test_item("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        run_test_item("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        run_test_item("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        run_test_item("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        run_test_item("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        run_test_item("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            run_test_item("Token verification works", False, str(e))
    else:
        run_test_item("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            run_test_item("Police token verification", False, str(e))
