...
def run_tests():
    ...
    try:
        ...
        verify("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        verify("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        verify("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        verify("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        verify("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        verify("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        verify("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            verify("Token verification works", False, str(e))
    else:
        verify("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            verify("Police token verification", False, str(e))
    ...
    if results['failed'] > 0:
        ...
        for verify_item in results['tests']:
            if verify_item['status'] == "FAIL":
                print(f"  - {verify_item['name']}")
                if verify_item['details']:
                    print(f"    {verify_item['details']}")
