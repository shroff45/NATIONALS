...
def run_tests():
    ...
    try:
        ...
        record_test("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        record_test("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        record_test("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        record_test("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        record_test("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        record_test("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        record_test("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            record_test("Token verification works", False, str(e))
    else:
        record_test("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            record_test("Police token verification", False, str(e))
