...
def run_test_case(name, condition, details=""):
    """Record test result"""
...
def run_tests():
    ...
    try:
        ...
        run_test_case("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        run_test_case("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        run_test_case("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        run_test_case("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        run_test_case("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        run_test_case("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        run_test_case("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            run_test_case("Token verification works", False, str(e))
    else:
        run_test_case("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            run_test_case("Police token verification", False, str(e))
