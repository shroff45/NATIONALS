...
def run_auth_test(name, condition, details=""):
    """Record test result"""
...
def run_tests():
    ...
    try:
        ...
        run_auth_test("Citizen signup succeeds", False, str(e))
        citizen_token = None
    ...
    try:
        ...
        run_auth_test("Citizen login succeeds", False, str(e))
    ...
    try:
        ...
        run_auth_test("Police signup succeeds", False, str(e))
        police_token = None
    ...
    try:
        ...
        run_auth_test("Judge signup succeeds", False, str(e))
        judge_token = None
    ...
    try:
        ...
        run_auth_test("Duplicate email prevention works", False, str(e))
    ...
    try:
        ...
        run_auth_test("Wrong password rejection works", False, str(e))
    ...
    try:
        ...
        run_auth_test("Google OAuth works", False, str(e))
    ...
    if citizen_token:
        try:
            ...
            run_auth_test("Token verification works", False, str(e))
    else:
        run_auth_test("Token verification skipped (no token)", False, "Citizen signup failed")
    ...
    if police_token:
        try:
            ...
            run_auth_test("Police token verification", False, str(e))
