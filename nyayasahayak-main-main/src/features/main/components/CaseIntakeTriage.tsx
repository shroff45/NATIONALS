...
const CaseIntakeTriage: React.FC<CaseIntakeTriageProps> = ({ t, allCases, setAllCases, selectedCase, setSelectedCase, language, currentUser, logActivity }) => {
    ...
    // Replaced useState/useEffect combo with useMemo for filteredCases.
    // This prevents unnecessary double re-renders when filtering state changes,
    // directly yielding the derived array and improving filtering performance.
