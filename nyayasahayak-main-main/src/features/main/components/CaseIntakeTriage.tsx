...
const CaseIntakeTriage: React.FC<CaseIntakeTriageProps> = ({ t, allCases, setAllCases, selectedCase, setSelectedCase, language, currentUser, logActivity }) => {
    ...
    // Replaced useState/useEffect with useMemo for derived state to eliminate an extra re-render cycle
    // Expected Impact: Reduces unnecessary React rendering when filters or cases change.
