...
const CaseIntakeTriage: React.FC<CaseIntakeTriageProps> = ({ t, allCases, setAllCases, selectedCase, setSelectedCase, language, currentUser, logActivity }) => {
    ...
    // Replaced useState/useEffect with useMemo for derived state to eliminate an unnecessary double re-render when filtering.
    // This directly yields the filtered array during the render cycle.
