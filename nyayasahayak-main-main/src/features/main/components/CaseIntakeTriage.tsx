...
const CaseIntakeTriage: React.FC<CaseIntakeTriageProps> = ({ t, allCases, setAllCases, selectedCase, setSelectedCase, language, currentUser, logActivity }) => {
    ...
    // What: Replaced useState/useEffect with useMemo for filteredCases.
    // Why: Deriving state via useEffect causes an initial render followed by an immediate second render.
    // Impact: Eliminates an unnecessary re-render cycle whenever search terms, filters, or cases change.
