...
const CaseIntakeTriage: React.FC<CaseIntakeTriageProps> = ({ t, allCases, setAllCases, selectedCase, setSelectedCase, language, currentUser, logActivity }) => {
    ...
    // ⚡ Bolt Performance Optimization: Replace useState + useEffect with useMemo for derived state
    // Prevents double re-renders when dependencies (searchTerm, activeCaseType, activePriority, allCases) change.
