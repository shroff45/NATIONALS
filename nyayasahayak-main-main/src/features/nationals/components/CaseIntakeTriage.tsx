...
const CaseIntakeTriage: React.FC<CaseIntakeTriageProps> = ({ t, allCases, setAllCases, selectedCase, setSelectedCase, language, currentUser, logActivity }) => {
    ...
    // ⚡ Bolt Optimization: Replaced useState+useEffect with useMemo for derived state.
    // Impact: Prevents double re-renders whenever search terms, filters, or the underlying case list changes.
