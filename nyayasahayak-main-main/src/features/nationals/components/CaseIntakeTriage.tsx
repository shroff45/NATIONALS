...
const CaseIntakeTriage: React.FC<CaseIntakeTriageProps> = ({ t, allCases, setAllCases, selectedCase, setSelectedCase, language, currentUser, logActivity }) => {
    ...
    // ⚡ Bolt: Replaced useState + useEffect with useMemo for filteredCases.
    // This prevents double re-renders when state dependencies change and improves performance.
