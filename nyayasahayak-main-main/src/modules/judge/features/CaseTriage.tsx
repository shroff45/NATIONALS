...
// Performance optimization: Memoized list item to prevent O(N) re-renders on selection change
const CaseListItem = memo(({ c, isSelected, onSelect }: { c: Case, isSelected: boolean, onSelect: (c: Case) => void }) => (
    <div
        onClick={() => onSelect(c)}
