...
const CaseQueuePage: React.FC = () => {
    ...
    // ⚡ Bolt Optimization:
    // 1. Memoized filteredCases to prevent O(N) array filtering on unrelated state changes (like selecting a case).
    // 2. Hoisted search.toLowerCase() outside the loop to execute once instead of 2N times.
