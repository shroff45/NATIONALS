...
const CaseQueuePage: React.FC = () => {
    ...
    // Optimize derivation by memoizing the result to prevent unnecessary recalculations on re-renders,
    // and hoisting the `search.toLowerCase()` call to save O(N) string conversions
