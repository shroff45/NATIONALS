...
const CaseQueuePage: React.FC = () => {
    ...
    // ⚡ Bolt Optimization:
    // 1. Added useMemo to prevent $O(N)$ filtering recalculations on unrelated re-renders (e.g., when selecting a case).
    // 2. Hoisted search.toLowerCase() to avoid redundant string allocations and conversions for every element in the array.
