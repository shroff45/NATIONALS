...
const CaseQueuePage: React.FC = () => {
    ...
    // Memoize the filtered cases to prevent recalculation on unrelated re-renders.
    // Hoisted search.toLowerCase() to avoid redundant string computations in the filter loop.
