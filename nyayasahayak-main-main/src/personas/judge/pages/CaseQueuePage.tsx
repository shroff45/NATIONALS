...
const CaseQueuePage: React.FC = () => {
    ...
    // 1. Added useMemo to prevent re-filtering on every render (e.g., when selectedCase changes).
    // 2. Hoisted search.toLowerCase() to avoid redundant string conversions inside the filter loop.
    // Expected Impact: Reduces unnecessary re-renders and CPU cycles during simple state updates.
