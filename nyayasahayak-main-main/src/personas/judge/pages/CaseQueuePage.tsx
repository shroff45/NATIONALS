...
const CaseQueuePage: React.FC = () => {
    ...
    // ⚡ Bolt: Memoize filtered cases and hoist string operations outside the loop
    // Impact: Prevents unnecessary filtering on re-renders and reduces string allocation
