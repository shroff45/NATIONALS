...
const CaseQueuePage: React.FC = () => {
    ...
    // ⚡ Bolt Optimization: Memoize filtered list and hoist string operations
    // Reduces re-calculations on unrelated state changes (like selecting a case)
    // and improves filter performance from O(N) to O(1) string allocations per run.
