...
const CaseQueuePage: React.FC = () => {
    ...
    // ⚡ Bolt Optimization: Memoize the filtered array to prevent unnecessary
    // re-calculations when unrelated state (like selectedCase) changes.
    // Hoist search.toLowerCase() to avoid redundant string operations in the loop.
