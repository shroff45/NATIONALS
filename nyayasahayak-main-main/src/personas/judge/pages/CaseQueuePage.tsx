...
const CaseQueuePage: React.FC = () => {
    ...
    // ⚡ Bolt: Memoize filtered cases and hoist search computation to prevent O(N) string operations
    // and avoid unnecessary re-evaluations when selectedCase changes.
