...
const CaseQueuePage: React.FC = () => {
    ...
    // 1. Added useMemo to prevent unnecessary recalculations of the filtered list on every render.
    // 2. Hoisted search.toLowerCase() outside the filter loop to avoid O(N) redundant string computations.
