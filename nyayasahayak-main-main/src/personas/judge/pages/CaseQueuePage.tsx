...
const CaseQueuePage: React.FC = () => {
    ...
    // Memoize the filtered cases list to prevent unnecessary re-computations
    // when unrelated state changes (like selecting a case). Also hoists the
    // `search.toLowerCase()` call to avoid redundant string conversions inside the loop.
