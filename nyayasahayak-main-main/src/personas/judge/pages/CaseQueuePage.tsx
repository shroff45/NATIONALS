...
const CaseQueuePage: React.FC = () => {
    ...
    // ⚡ Bolt: Memoized derived state to prevent re-computation on every render unless search or filter changes.
    // Also hoisted search.toLowerCase() outside the loop to avoid repetitive string operations.
