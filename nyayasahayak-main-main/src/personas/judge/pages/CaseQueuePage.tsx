...
const CaseQueuePage: React.FC = () => {
    ...
    // ⚡ Bolt Optimization: Memoize filtered cases and hoist lowercasing to prevent redundant
    // O(N) recalculations and O(N) string transformations when unrelated state (selectedCase) changes
