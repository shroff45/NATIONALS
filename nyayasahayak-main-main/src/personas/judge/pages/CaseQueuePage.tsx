...
const CaseQueuePage: React.FC = () => {
    ...
    // 1. Memoized filteredCases to prevent unnecessary recalculation on component re-renders (e.g. when selectedCase changes)
    // 2. Hoisted search.toLowerCase() to avoid redundant string allocations and `.toLowerCase()` calls during the array iteration
