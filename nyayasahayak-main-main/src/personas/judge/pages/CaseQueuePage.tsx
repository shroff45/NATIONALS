...
const CaseQueuePage: React.FC = () => {
    ...
    // ⚡ Bolt: Memoize filtered cases to prevent re-computation on selectedCase changes
    // Hoisted toLowerCase() outside the loop to prevent O(N) redundant string conversions
