...
const EvidenceVault: React.FC = () => {
    ...
    // ⚡ Bolt: Memoize filtered cases and hoist the lowercased search query to prevent unnecessary re-renders and recalculations
    const filteredCases = useMemo(() => {
        const lowerSearchQuery = searchQuery.toLowerCase();
        return MOCK_CASES.filter(c =>
            c.title.toLowerCase().includes(lowerSearchQuery) ||
            c.cnr.toLowerCase().includes(lowerSearchQuery)
        );
    }, [searchQuery]);
