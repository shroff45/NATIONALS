...
const EvidenceVault: React.FC = () => {
    ...
    // ⚡ Bolt Performance Optimization: Memoize filtered list to prevent unnecessary derivations on every render
    ...
    // ⚡ Bolt Performance Optimization: Memoize selected case to prevent unnecessary lookups on every render
