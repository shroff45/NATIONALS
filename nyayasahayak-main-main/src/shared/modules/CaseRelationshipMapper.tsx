...
const CaseRelationshipMapper: React.FC<CaseRelationshipMapperProps> = ({ t, selectedCase }) => {
    ...
    const renderContent = () => {
        ...
        const nodes = {
            case: { x: 50, y: 50, label: selectedCase.caseNumber || 'Unknown', type: 'case' as const },
            petitioner: { x: 20, y: 30, label: selectedCase.petitioner || 'Unknown', type: 'person' as const },
            respondent: { x: 80, y: 30, label: selectedCase.respondent || 'Unknown', type: 'person' as const },
